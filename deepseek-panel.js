        ...
        function (error, response, data) {
            ...
            try {
                ...
                if (json.balance_infos && json.balance_infos.length > 0) {
                    ...
                    $persistentStore.write(info.total_balance, "deepseek_balance_total");
                    $persistentStore.write(info.granted_balance, "deepseek_balance_granted");
                    $persistentStore.write(info.topped_up_balance, "deepseek_balance_topped_up");
